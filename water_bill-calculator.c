...
/*A programme that prompts the user to enter thenumber of water units consumed,calculates the total bill depending on the charges and displays the total bill in 2 decimal places*/
